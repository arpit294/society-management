...
class ExpenseController extends Controller
{
    public function index(ExpensesDataTable $dataTable)
    {
        ...
        try {
            ...
            $totalMaintenanceIncome = MaintenanceBill::where('status', config('status.maintenance_bills.paid', 'paid'))->sum('total_amount')
                                    + NameTransferBill::where('status', config('status.name_transfer_bills.paid', 'paid'))->sum('amount');
