        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select name="unit_type" id="unit_type_select_edit" class="form-select">
                    <option value="flat" {{ old('unit_type', $flat->unit_type) == 'flat' ? 'selected' : '' }}>Flat / Apartment</option>
                    <option value="shop" {{ old('unit_type', $flat->unit_type) == 'shop' ? 'selected' : '' }}>Commercial Shop</option>
                    <option value="office" {{ old('unit_type', $flat->unit_type) == 'office' ? 'selected' : '' }}>Commercial Office</option>
            ...
            <div class="col-md-6">
                ...
                <input type="number" step="0.01" name="area_sqft" class="form-control" value="{{ old('area_sqft', $flat->area_sqft) }}" placeholder="e.g. 1200.50">
                @error('area_sqft')
                    <div class="invalid-feedback d-block field-error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="electricity_meter_no" class="form-control" value="{{ old('electricity_meter_no', $flat->electricity_meter_no) }}" placeholder="Optional">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="water_meter_no" class="form-control" value="{{ old('water_meter_no', $flat->water_meter_no) }}" placeholder="Optional">
            ...
            <div class="col-md-6 d-flex align-items-center mt-4">
                <div class="form-check form-switch p-2 px-3 bg-body-tertiary rounded border w-100 d-flex align-items-center justify-content-between">
                    <label class="form-check-label small fw-semibold mb-0" for="has_commercial_license_edit">Has Commercial License / Shop</label>
                    <input class="form-check-input m-0" type="checkbox" id="has_commercial_license_edit" name="has_commercial_license" value="1" {{ old('has_commercial_license', $flat->has_commercial_license) ? 'checked' : '' }}>
                </div>
            </div>
        </div>
        <script>
