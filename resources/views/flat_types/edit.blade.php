<form action="{{ route('flat-types.update', $flatType->id) }}" method="POST" id="flat-type-ajax-form">
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <label for="penalty_per_day" class="form-label">Penalty / Day <span class="text-danger">*</span></label>
                <div class="input-group">
                    <span class="input-group-text">$</span>
            ...
            <div class="col-md-12 mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="3">{{ $flatType->description }}</textarea>
            </div>
