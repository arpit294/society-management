...
<form id="addDocumentForm" class="add-document-form" action="{{ route('flat-documents.store') }}" method="POST" enctype="multipart/form-data" data-settings="{{ json_encode($settings) }}" data-requirements="{{ json_encode($documentRequirements) }}">
    ...
    <div class="modal-body">
        <div class="row mb-3">
            <div class="col-md-4">
                <label for="block_id" class="form-label text-body">Block <span class="text-danger">*</span></label>
            ...
            <div class="col-md-4">
                <label for="flat_id" class="form-label text-body">Flat <span class="text-danger">*</span></label>
                <select name="flat_id" id="flat_id" class="form-select select2" required style="width: 100%;">
                    <option value="">Select Flat</option>
                </select>
            </div>
            <div class="col-md-4">
                <label for="user_id" class="form-label text-body">Resident <span class="text-danger">*</span></label>
